...
<head>
    ...
    <style>
        body {
            background-image: url('../img/img02.JPG'); /* Caminho para a sua imagem */
        ...
        .card {
            background: rgba(255, 255, 255, 0.8); /* Transparência no card */
            border-radius: 10px;
            padding: 20px;
            width: 100%; /* Faz o card ocupar toda a largura disponível dentro do col */
            max-width: 400px; /* Define uma largura máxima para o card */            border-radius: 10px;
            padding: 20px;
        }
    </style>
</head>
